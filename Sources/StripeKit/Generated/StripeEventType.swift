...
/// The type of a Stripe webhook event.
/// Generated from the OpenAPI spec's `event.type` enum values.
public enum StripeEventType: String, Codable, Sendable {
    ...
    /// An event type not yet known to this version of StripeKit.
    case unknown
