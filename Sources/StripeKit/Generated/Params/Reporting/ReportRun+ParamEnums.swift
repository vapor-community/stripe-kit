...
public enum ReportRunCreateParametersReportingCategory: String, Codable, Sendable {
    case advance
...
public enum ReportRunCreateParametersTimezone: String, Codable, Sendable {
