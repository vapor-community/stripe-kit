...
public struct ApiErrors: Codable, Sendable {
    /// For card errors resulting from a card issuer decline, a short string indicating [how to proceed with
    ...
    /// A human-readable message providing more details about the error. For card errors, these messages can
    ...
    /// For payments declined by the network, an alphanumeric code which indicates the reason the payment
    /// failed.
...
/// For some errors that could be handled programmatically, a short string indicating the [error
/// code](https://docs.stripe.com/error-codes) reported.
public enum ApiErrorsCode: String, Codable, Sendable {
...
/// The type of error returned. One of `api_error`, `card_error`, `idempotency_error`, or
/// `invalid_request_error`
public enum ApiErrorsType: String, Codable, Sendable {
...
public struct ApiErrorsList: Codable, Sendable {
    public var object: String
    public var hasMore: Bool?
    public var url: String?
    public var data: [ApiErrors]?
