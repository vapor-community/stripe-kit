...
public struct DisputeEvidence: Codable {
    ...
    @Expandable<StripeFile> public var cancellationPolicy: String?
    ...
    @Expandable<StripeFile> public var customerCommunication: String?
    ...
    @Expandable<StripeFile> public var customerSignature: String?
    /// (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Documentation for the prior charge that can uniquely identify the charge, such as a receipt, shipping label, work order, etc. This document should be paired with a similar document from the disputed payment that proves the two payments are separate.
    @Expandable<StripeFile> public var duplicateChargeDocumentation: String?
    ...
    @Expandable<StripeFile> public var receipt: String?
    /// (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Your refund policy, as shown to the customer.
    @Expandable<StripeFile> public var refundPolicy: String?
    ...
    @Expandable<StripeFile> public var serviceDocumentation: String?
    ...
    @Expandable<StripeFile> public var shippingDocumentation: String?
