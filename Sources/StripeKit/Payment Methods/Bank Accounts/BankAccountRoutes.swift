...
public protocol BankAccountRoutes {
    ...
    ///   - expand: An array of properties to expand.
    /// - Returns: A `StripeBankAccount`.
    func retrieve(id: String, customer: String, expand: [String]?, context: LoggingContext) -> EventLoopFuture<StripeBankAccount>
    ...
    ///   - expand: An array of properties to expand.
    /// - Returns: A `StripeBankAccount`.
    func verify(id: String, customer: String, amounts: [Int]?, expand: [String]?, context: LoggingContext) -> EventLoopFuture<StripeBankAccount>
    ...
    func listAll(customer: String, filter: [String: Any]?, context: LoggingContext) -> EventLoopFuture<StripeBankAccountList>
...
public struct StripeBankAccountRoutes: BankAccountRoutes {
    ...
    public func create(customer: String, source: Any, metadata: [String: String]?, expand: [String]?, context: LoggingContext) -> EventLoopFuture<StripeBankAccount> {
        var body: [String: Any] = [:]
